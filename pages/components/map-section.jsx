...
export default function Map(){
    ...
    return(
        <>
            <div className='relative mb-48 lg:mb-48'>
                <Image src={map} alt="map of southeastern United States" className="w-full h-80 lg:h-96 map"/>

            
                <div className='absolute top-20 left-0 right-0 w-11/12 bg-white shadow-lg shadow-black mx-auto py-4 lg:top-20 lg:left-20 lg:right-20 lg:w-3/5 mapMax'>
                    ...
                    <div className='w-11/12 mt-8 mb-12 mx-auto py-4 border-2 border-black text-center hover:bg-red-600 hover:text-white text-2xl font-semibold sm:w-80 lg:w-96 lg:py-6 cursor-pointer'><p>Nerby Locations</p></div>
                </div>
